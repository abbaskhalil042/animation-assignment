...
const DiscoverSec = () => {
  ...
  return (
    <section className="mt-10 ">
      <div className=" flex flex-col sm:m-auto justify-center lg:text-6xl font-bold lg:mt-[1rem] items-center">
        <h1 className="flex lg:text-6xl  mb-10 sm:text-[2.5rem] flex-col text-center ">
