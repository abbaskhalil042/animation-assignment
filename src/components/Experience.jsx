    ...
    <section className=" flex jusctify-between m-auto lg:flex-row sm:flex-col sm-m-auto  mt-16 ">
      ...
      <div className="lg:w-[60%]  ">
        ...
        <div className="lg:block sm:hidden">
          <img
            className="img-extension sm:left-[2rem] sm:top-[390rem] absolute lg:top-[330rem] lg:left-[37.8rem]"
            src="https://www.google.com/chrome/static/images/dev-components/extensions-shop.png"
            alt=""
          />
          <img
            className="img-extension absolute sm:left-[30rem] sm:top-[363rem] sm:w-[20%] lg:w-[10rem] lg:top-[320rem] lg:left-[70rem]"
            src="https://www.google.com/chrome/static/images/dev-components/extensions-icon.png"
            alt=""
          />
          <img
            className="img-extension absolute sm:top-[378rem] sm:right-[3rem] lg:top-[333rem] lg:right-[2rem]"
            src="https://www.google.com/chrome/static/images/dev-components/extensions-video.png"
            alt=""
          />
          <img
            className="img-extension absolute sm:top-[390rem] sm:right-[10rem] lg:top-[347rem] lg:right-[10rem]"
            src="https://www.google.com/chrome/static/images/dev-components/extensions-paint.png"
            alt=""
          />

          <img
            className="img-extension absolute sm:top-[390rem] sm:left-[10rem] lg:top-[347rem] lg:left-[45rem]"
